var Profile_View = {
    ...
    dtOptionsTable: function ()
    {
        ...
        if (Profile_Base.permissions.view_permission)
        {
            html +=
                    '<a title="" class="btn btn-primary btn-icon btn-xs tip dt-action-view-permission" href="javascript:;" data-original-title="Permisos"><i class="icon-accessibility"></i></a> ';
        }
        if (Profile_Base.permissions.delete)
        {
            html +=
