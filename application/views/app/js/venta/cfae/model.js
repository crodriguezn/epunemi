var ControlVentaCFAE_Model = {
    loadAcount: function (id_user, fResponse)
    {
        $.ajax({
            url: Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-acount'),
            method: 'post',
            dataType: 'json',
    ...
    {
        $.ajax({
            url: Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-components'),
            method: 'post',
            dataType: 'json',
            data: {},
            success: function (data, textStatus, jqXHR) // Function( PlainObject data, String textStatus, jqXHR jqXHR )
    ...
    {
        Core.Ajax.post(
                Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-pais'),
                {},
                fSuccess,
                fFail
                );
    ...
    {
        Core.Ajax.post(
                Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-provincia'),
                {id_pais: id_pais},
        fSuccess,
                fFail
                );
    ...
    {
        Core.Ajax.post(
                Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-ciudad'),
    ...
    {
        $.ajax({
            url: Core.site_url(ControlVentaCFAE_Base.linkx + '/process/save-acount'),
            method: 'post',
            dataType: 'json',
            data: data,
    ...
    loadPersonByDocument: function (document, fResponse)
    {
        ...
        self.ajax1 = $.ajax({
            url: Core.site_url(ControlVentaCFAE_Base.linkx + '/process/load-person-by-document'),
            method: 'post',
            dataType: 'json',
