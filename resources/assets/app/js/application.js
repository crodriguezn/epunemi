...
//	});
	...
	$("select.minimum-multiple-select").select2({
        minimumInputLength: 2,
        width: "100%" 
    });
	...
	$("select.select-disabled").select2(
        "enable", false
    );
